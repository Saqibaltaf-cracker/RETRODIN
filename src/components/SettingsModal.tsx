...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    ...
    >
      ...
      <div 
        className="relative w-full max-w-md sm:max-w-lg flex flex-col rounded-lg border border-[var(--color-lcd-primary)]/30 bg-black text-zinc-100 shadow-[0_0_50px_rgba(0,0,0,1),0_0_25px_rgba(var(--color-lcd-primary-rgb),0.25)] overflow-hidden"
      >

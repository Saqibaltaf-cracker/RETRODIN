...
export const JDM_STATIONS = [
  ...
  { preset: 2, freq: 80.0, name: 'INDIAN GHAZAL 80.0', url: 'https://stream.zeno.fm/yo0kzyzedittv' }, // Indian Ghazals 24/7
...
export function useStereo() {
  ...
  const cycleTheme = () => {
    ...
    const themeLabels: Record<StereoTheme, string> = {
      ...
      'white': 'COLOR: VFD WHITE',
      'full-white': 'COLOR: FULL MONO WHITE',
